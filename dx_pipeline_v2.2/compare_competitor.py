...
# 2026-07-21 정밀화: 초안 패턴은 "제품 등록" 단순 언급까지 잡아 긍정 리뷰가 16.1% 섞였음
# (예: "제품등록이 쉽네요"). 소실·재작업을 명시한 표현만 남겨 오탐률 11.3%로 축소.
P2_PATTERN = (r"재등록|다시\s*등록|첨부터\s*다시|처음부터\s*다시"
              r"|등록.{0,10}(날아|사라|없어|삭제|초기화|풀리)"
              r"|(제품|기기|설정|목록).{0,12}(날아|사라|없어졌|다\s*삭제|초기화)"
              r"|초기화.{0,10}(되|됨|시켜|후)")
